...
public partial class MainPage
{
   ...
   protected override void OnAppearing()
   {
      ...
      Products.Add(new Product
      {
         ...
         Description =
            "The 'little brother'. Has all the same hardware as the flagship XT16 but with a smaller screen.",
         Price = 1099,
      ...
      Products.Add(new Product
      {
         ...
         Description =
            "Our entry level Gigaphone. It looks cool, but doesn't make calls or access the internet. It does play cool jingles though!",
         Price = 699,
