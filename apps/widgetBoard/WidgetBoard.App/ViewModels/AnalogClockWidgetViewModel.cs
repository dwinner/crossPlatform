...
public partial class AnalogClockWidgetViewModel : ViewModelBase, IWidgetViewModel, IDrawable
{
   ...
   public AnalogClockWidgetViewModel(IDispatcher aDispatcher)
   {
   ...
   public void Draw(ICanvas canvas, RectF dirtyRect)
   {
      ...
      canvas.StrokeSize = 5;
      canvas.StrokeColor = Application.Current?.PlatformAppTheme == AppTheme.Dark
         ? Colors.White
         : Colors.Black;
   ...
   {
      Time = aDateTime;
      _dispatcher.DispatchDelayed(TimeSpan.FromSeconds(1), () => SetTime(DateTime.Now));
   }
}