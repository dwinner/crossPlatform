...
public partial class MainViewModel : ObservableObject
{
   ...
   {
      using var unitOfWork = new CrmUnitOfWork();
      Customers = new ObservableCollection<Customer>(await unitOfWork.Items.GetAllAsync());
      Refreshing = false;
   }
   ...
   private async Task DeleteCustomerAsync(Customer customer)
   {
      ...
      try
      {
         await unitOfWork.Items.DeleteAsync(customer);
